...
subtest 'cell_get' => sub {
    ...
    is( Zigzag::cell_get('103'), undef, 'non-existent cell');
};
...
# Moved get_cursor to its new alphabetical position
subtest 'get_cursor' => sub {
    # This test relies on initial_geometry and should run before tests that might corrupt Zigzag.pm's global state.
    # Use the standard way of initializing $test_slice for tests expecting initial_geometry.
    %$test_slice = Zigzag::initial_geometry();
